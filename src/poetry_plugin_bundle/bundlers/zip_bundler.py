...
# TODO:
# - Consider changing to has-a for VenvBundler instead of is-a.
# - Flag for .so strip
# - Flag for nested ZIP
    ...
    def bundle(self, poetry: Poetry, io: IO) -> bool:
        ...
        with TemporaryDirectory() as temp_virtual_env:
            ...
            for file in Builder(poetry).find_files_to_add():
                ...
                venv_file_path = zip_src_root_path / venv_sub_path
